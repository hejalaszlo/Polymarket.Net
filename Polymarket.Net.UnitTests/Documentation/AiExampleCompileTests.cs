...
namespace Polymarket.Net.UnitTests.Documentation
{
    [TestFixture]
    public class AiExampleCompileTests
    {
        ...
        private static string GetRepositoryRoot()
        {
            ...
            {
                if (File.Exists(Path.Combine(directory.FullName, "Polymarket.Net.sln")))
                    return directory.FullName;

                directory = directory.Parent;
            }

            throw new DirectoryNotFoundException("Could not find repository root containing Polymarket.Net.sln.");
        }
    }
}
